...
public class MybatisPlusConfiguration {
     ...
     */
//    @Bean
//    public SqlLogFilter sqlLogFilter(SqlLogProperties properties) {
...
//    }
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "mybatis-plus.log.isSql", matchIfMissing = true)
     ...
     */
    @Bean
    @ConditionalOnMissingBean(AutoMetaObjectHandler.class)
    public AutoMetaObjectHandler mateMetaObjectHandler() {
