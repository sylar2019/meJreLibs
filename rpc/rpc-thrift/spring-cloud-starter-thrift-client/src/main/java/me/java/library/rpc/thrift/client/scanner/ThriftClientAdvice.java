...
import me.java.library.rpc.thrift.client.exception.*;
import me.java.library.rpc.thrift.client.loadbalancer.IRule;
import me.java.library.rpc.thrift.client.loadbalancer.RoundRobinRule;
import me.java.library.rpc.thrift.client.loadbalancer.ThriftConsulServerListLoadBalancer;
import me.java.library.rpc.thrift.client.pool.TransportKeyedObjectPool;
import me.java.library.rpc.thrift.client.properties.ThriftClientPoolProperties;
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        while (true) {
            ...
            try {
                ...
                } else if (undeclaredThrowable instanceof TApplicationException) {
                    // 有可能服务端返回的结果里存在null
                    LOGGER.error(
                ...
                } else if (undeclaredThrowable instanceof TException) {
                    // idl exception
