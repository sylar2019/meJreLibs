...
public class RandomUtils {
    ...
    public static <T extends Enum> T getRandomEnum(Class<T> enumType) {
        int len = enumType.getEnumConstants().length;
        return enumType.getEnumConstants()[new Random().nextInt(len)];
    }
    ...
    public static <T> Iterable<T> getRandom(Iterable<T> source) {
