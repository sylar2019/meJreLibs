...
// * *******************************************************************************************
// */
//public abstract class AbstractPipe1<B extends Bus, C extends Codec> implements Pipe {
...
//
//    public AbstractPipe1(B bus, C codec) {
//        this("default", bus, codec);
//    }
//
//    public AbstractPipe1(String hostCode, B bus, C codec) {
...
//                AbstractPipe1.this.channel = channel;
//                ChannelAttr.set(channel, ChannelAttr.ATTR_PIPE, AbstractPipe1.this);
//
...
//        if (watcher != null) {
//            ConcurrentService.getInstance().postRunnable(() -> watcher.onHostStateChanged(AbstractPipe1.this.host, isRunning));
//        }
//    }
//
...
//        if (watcher != null) {
//            ConcurrentService.getInstance().postRunnable(() -> watcher.onPipeRunningChanged(AbstractPipe1.this, isRunning));
//        }
//    }
//
//    protected void onConnectionChanged(Terminal terminal, boolean isConnected) {
//        if (watcher != null) {
//            ConcurrentService.getInstance().postRunnable(() -> watcher.onConnectionChanged(AbstractPipe1.this, terminal, isConnected));
//        }
//    }
//
...
//        if (watcher != null) {
//            ConcurrentService.getInstance().postRunnable(() -> watcher.onReceived(AbstractPipe1.this, cmd));
//        }
//    }
//
//    protected void onException(Throwable t) {
//        if (watcher != null) {
//            ConcurrentService.getInstance().postRunnable(() -> watcher.onException(AbstractPipe1.this, t));
//        }
//    }
//
//    /**
...
//                loop.schedule(AbstractPipe1.this::start, daemonSeconds, TimeUnit.SECONDS);
//            }
//        }
//    }
//
