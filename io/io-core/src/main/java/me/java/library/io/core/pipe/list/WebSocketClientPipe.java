...
import me.java.library.io.core.codec.list.websocket.WebSocketClientCodec;
 ...
 * *******************************************************************************************
 */
public class WebSocketClientPipe extends AbstractPipe<TcpClientBus, WebSocketClientCodec> {
    public WebSocketClientPipe(TcpClientBus bus, WebSocketClientCodec codec) {
        super(bus, codec);
    }
